        ...
        <>
          ...
          {allPosts.map((postData, index) => {
            ...
            const handleEditKey = async (
              ...
              console.log(`handleEditKey handler`, postId, key);
                        ...
                        return (
                          <>
                            <Dialog
                              ...
                              onOpenChange={() => setEditOpen(obj.key)}
                            >
                              <DialogContent>
                                <DialogHeader>
                                  <DialogTitle>
                                ...
                                <Form {...editForm}>
                                  <form
                                    onSubmit={editForm.handleSubmit((data) =>
                                      handleEditKey(data, postData._id, obj.key)
                                    )}
                                    className="space-y-4"
                                  >
                                    <FormItem>
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      ...
                                      <AlertDialogDescription>
                                        ...
                                        permanently delete this card data from
                                        our servers.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
